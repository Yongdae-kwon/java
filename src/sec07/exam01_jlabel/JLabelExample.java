...
public class JLabelExample extends JFrame {
	...
	public JLabel getJLabel1 () {
		if(jLabel1 == null) {
			...
			jLabel1.setHorizontalAlignment(JLabel.LEFT); // 텍스트 왼쪽 정렬
			jLabel1.setBorder(new EtchedBorder());
		} return jLabel1;
	}	
	// JLabe2 생성 : 이미지 추가 , 텍스트 중앙 정렬
	...
	public JLabel getJLabel3 () {
		if(jLabel3 == null) {
			...
			jLabel3.setHorizontalTextPosition(JLabel.RIGHT); // 텍스트가 이미지의 왼쪽 표기
			jLabel3.setBorder(new EtchedBorder());
		} return jLabel3;
	}	
	// JLabel4 생성 : 이미지와 텍스트 사이의 간격 설정
